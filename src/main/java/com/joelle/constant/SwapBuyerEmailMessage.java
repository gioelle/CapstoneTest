...
public class SwapBuyerEmailMessage {
	
public static String buildSwapBuyerEmail(User loggedInUser, User postedUser, Posting post) {
	return "\r\n" + 
			...
			"                          <span style=\"color: #3f3f3f;\">"+post.getTitle()+"</span>\r\n" + 
			"                        </td>\r\n" + 
			...
			"                        </td>\r\n" + 
			"                      </tr><tr><td align=\"left\" class=\"long-text links-color\" style=\"text-align: left; font-size: 13px; font-family: Arial, Helvetica, sans-serif; color: #3f3f3f;\"><p style=\"margin: 1em 0px;margin-bottom: 0px;margin-top: 0px;\">After the swap has been completed, please visit your home page to rate your interaction based on how accurate the description of the "+post.getType()+" is and how communicating and interacting with "+postedUser.getFirstName()+" went.<br></p></td>\r\n" + 
			"                      </tr><tr><td valign=\"top\">\r\n" + 
